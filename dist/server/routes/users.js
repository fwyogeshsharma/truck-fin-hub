...
import { getAllUsers, getUserById, getUserByEmail, getUserByUserId, getUsersByRole, createUser, updateUser, deleteUser, updatePassword, getPendingUserApprovals, approveUser, rejectUser, } from '../../src/db/queries/users.ts';
const router = Router();
...
router.get('/pending-approvals', async (req, res) => {
    try {
        ...
        const pendingUsers = await getPendingUserApprovals(companyId);
        // Remove password hashes from response
