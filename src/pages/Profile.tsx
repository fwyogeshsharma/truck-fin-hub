    ...
    <DashboardLayout role={user.role}>
      <div className="space-y-4 sm:space-y-6 px-3 sm:px-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-muted-foreground mt-1">Manage your account and wallet</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <Avatar className="h-16 w-16 sm:h-20 sm:w-20 flex-shrink-0">
                      <AvatarFallback className="bg-gradient-primary text-primary-foreground text-xl sm:text-2xl">
                        {user.name?.charAt(0).toUpperCase() || 'U'}
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex-1 min-w-0">
                      <CardTitle className="text-lg sm:text-xl md:text-2xl truncate">{user.name}</CardTitle>
                      <CardDescription className="flex flex-wrap items-center gap-2 mt-1 sm:mt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="font-medium text-sm sm:text-base">{user.phone || 'Not specified'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="font-medium text-sm sm:text-base">{getRoleDisplayName(user.role)}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="font-medium font-mono text-[10px] sm:text-xs break-all">{user.id}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <Button
              ...
              className="w-full bg-gradient-primary min-h-[48px] sm:min-h-[44px]"
              size="lg"
            >
              <Wallet className="h-4 w-4 mr-2" />
              <span className="text-sm sm:text-base">View Wallet Details</span>
        ...
        <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
          <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3 sm:space-y-4 py-3 sm:py-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`min-h-[44px] text-sm ${validationErrors.email ? 'border-red-500' : ''}`}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`min-h-[44px] text-sm ${validationErrors.phone ? 'border-red-500' : ''}`}
                />
            ...
            <DialogFooter className="flex-col sm:flex-row gap-2">
              <Button variant="outline" onClick={() => setEditDialogOpen(false)} disabled={saving} className="w-full sm:w-auto min-h-[44px]">
                Cancel
              </Button>
              <Button
