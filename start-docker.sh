...
CREATE TABLE IF NOT EXISTS contracts (
  ...
  -- Foreign key constraints (using DO block to handle if users table doesn't exist)
  CONSTRAINT fk_contracts_party1 FOREIGN KEY (party1_user_id) REFERENCES users(id) ON DELETE RESTRICT,
  CONSTRAINT fk_contracts_party2 FOREIGN KEY (party2_user_id) REFERENCES users(id) ON DELETE RESTRICT,
  CONSTRAINT fk_contracts_party3 FOREIGN KEY (party3_user_id) REFERENCES users(id) ON DELETE RESTRICT,
  CONSTRAINT fk_contracts_uploaded_by FOREIGN KEY (uploaded_by) REFERENCES users(id) ON DELETE CASCADE
);
