        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          {filteredTrips.length === 0 ? (
            ...
            paginatedTrips.map((trip) => {
              ...
              return (
                <Card key={trip.id} className="p-2 sm:p-2.5">
                          ...
                          {trip.riskLevel && (
                            <Tooltip>
                              ...
                              <TooltipContent className="md:hidden">
                                <p>
                                  {trip.riskLevel === 'low' ? 'Low Risk' :
                                   trip.riskLevel === 'medium' ? 'Medium Risk' : 'High Risk'}
                                </p>
                              </TooltipContent>
                            </Tooltip>
                          )}
                              ...
                              <Popover>
                                <PopoverTrigger asChild>
                                  <button className="flex items-center gap-2 px-3 py-1.5 bg-muted/50 rounded-lg border border-border hover:bg-muted transition-colors">
                                    ...
                                    {(() => {
                                      const companyInfo = getCompanyInfo(trip.loadOwnerName);
                                      const rating = companyInfo?.rating || trip.loadOwnerRating || trip.rating;
                                      return rating && (
